# ✅ Fix Constraint - Kør Dette Nu!

## Problem:

Der er eksisterende data med ugyldige værdier (1-5), så vi kan ikke tilføje den nye constraint før dataene er opdateret.

## Løsning - Kør Dette Komplette Script:

### Gå til Supabase Dashboard → SQL Editor

### Kør Dette Script (rækkefølgen er kritisk):
...
-- Step 2: Update existing data (convert 1-5 to 80-100)
UPDATE public.wines
SET 
    balance = CASE 
...
1. Først drop constraint (så vi kan opdatere data)
2. Derefter opdater data (1→80, 2→85, osv.)
...
**Kør hele scriptet - dette burde fixe det!** ✅
